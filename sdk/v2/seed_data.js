import {
    connect_db,
    crear_usuario, crear_rol, crear_permiso, asignar_permiso_a_rol
} from './database.js';
...
// Crear múltiples usuarios para prueba
...
// Crear 20 usuarios más para tener suficientes registros
for (let i = 6; i <= 25; i++) {
...
console.log('   GET  /usuarios/listar - Listar todos los usuarios');
console.log('   GET  /roles/listar - Listar todos los roles');
console.log('   GET  /permisos/listar - Listar todos los permisos');
console.log('   GET  /roles/permisos?role_id=1 - Ver permisos de un rol');
